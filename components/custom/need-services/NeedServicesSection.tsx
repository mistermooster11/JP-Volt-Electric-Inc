    ...
    <section className="need-services" ref={sectionRef}>
      <div className="need-services__inner">
        <h2 className="need-services__heading">
          ...
          <br />in West Palm Beach?
        </h2>
        <p className="need-services__text">
          From panel upgrades to EV charger installs — JP Volt Electric is ready to help.
          <br />Contact us for a free estimate. Licensed, insured, and code-compliant.
        </p>
