    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">Licensed &amp; Insured</div>
          <h2 className="testimonials__heading">Trusted When It Matters Most</h2>
          <p className="testimonials__subtext">
            Our clients in West Palm Beach and Palm Beach County rely on JP Volt Electric for
            professional electrical work — panel upgrades, EV chargers, smart home, and more —
            done right, to code, the first time.
          </p>
        </div>
