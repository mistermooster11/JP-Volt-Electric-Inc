          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                625 El Vedado, West Palm Beach,&nbsp;Florida&nbsp;33405
              </p>
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+17864511973">(786) 451-1973</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                <Link href="mailto:jpvoltelectric@gmail.com">jpvoltelectric@gmail.com</Link>
              </p>
            </div>
