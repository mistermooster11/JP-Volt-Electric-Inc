    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Licensed Electrical Services in West Palm Beach &amp; Palm Beach County
        </h2>
        <p className="services__subtext">
          From panel upgrades and EV charger installs to smart home automation and full electrical
          wiring — JP Volt Electric handles it all, licensed, permitted, and to code.
        </p>
      </div>
