    ...
    <section className="hero">
      ...
      <div className="hero__content">
        ...
        <p className="hero__description" ref={descRef}>
          JP Volt Electric Inc — licensed, insured electrical contractor
          <br />
          serving West Palm Beach and Palm Beach County. Panel upgrades,
          <br />
          EV chargers, smart home, and full electrical services.
        </p>
