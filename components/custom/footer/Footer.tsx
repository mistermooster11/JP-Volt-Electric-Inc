  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>JP Volt Electric Inc</strong> is a licensed electrical contractor serving
            West Palm Beach and Palm Beach County. Panel upgrades, EV chargers, smart home
            automation, and full electrical services — done right, to code, the first time.
          </p>
          <div className="footer__socials">
            <a href="https://www.facebook.com/profile.php?id=100089103150752" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-link">
            ...
            <a href="https://instagram.com/jpvoltelectric" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer__social-link">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 JP Volt Electric Inc. All rights reserved.</p>
