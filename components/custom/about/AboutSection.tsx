      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            West Palm Beach&apos;s Trusted Electrical Contractor —
            Licensed, Skilled &amp; Committed Since Day One
          </h2>
          <p className="about__text">
            JP Volt Electric Inc is a licensed electrical contractor serving
            West Palm Beach and Palm Beach County. Founded by Junior Paez, a
            Florida-licensed electrical contractor (EC13011506), our team brings
            over 10 years of experience to every job — from panel upgrades and
            EV charger installs to smart home automation and full electrical
            wiring projects.
          </p>
          <p className="about__text">
            We value our clients, their time, and their expectations. Every job
            is performed to NEC code standards, properly permitted, and inspected
            to give you peace of mind. Contact us for a free estimate and
            experience the difference of working with electricians who treat your
            home like their own.
          </p>
        ...
        <div className="about__media">
          <div className="about__img-wrap">
            <Image
              ...
              alt="JP Volt Electric Inc — electrician at work"
              width={690}
              height={613}
