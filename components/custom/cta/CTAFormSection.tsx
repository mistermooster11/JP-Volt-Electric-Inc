...
export default function CTAFormSection() {
  ...
  const WHY_LEFT = [
    ...
    "Licensed (EC13011506) and fully insured",
  ...
  const WHY_RIGHT = [
    ...
    "Panel upgrades, EV chargers, smart home & more",
  ];
      ...
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          ...
          <h2 className="cta-form__heading hidden md:block">
            We are always ready <br />to help with your electrical needs
          </h2>
          <h2 className="cta-form__heading block md:hidden">
            Get in touch
          </h2>
          <p className="cta-form__subtext hidden md:block">
            Free estimates — Licensed electricians for West Palm Beach
            <br />and Palm Beach County — All work to code
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            JP Volt Electric provides licensed, permit-ready electrical work for homes and
            businesses across West Palm Beach and Palm Beach County. Whether you&apos;re upgrading
            your panel, installing an EV charger, or automating your home — we handle it right
            the first time.
          </p>
          <p className="cta-form__text">
            With over 10 years of experience and Florida Electrical Contractor License EC13011506,
            Junior Paez and the JP Volt team deliver efficient, professional results on every job.
            Call us or fill out the form for your free estimate.
          </p>
