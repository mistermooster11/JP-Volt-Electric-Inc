  ...
  return (
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        ...
        <h2 className="pricing__heading">Transparent Electrical Pricing</h2>
        <p className="pricing__subtext">
          Clear, upfront pricing for electrical services in West Palm Beach and Palm Beach County.
          Free estimates on all projects — you approve the price before any work begins.
        </p>
      </div>
